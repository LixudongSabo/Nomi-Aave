...
import {IParaSwapAugustus} from '../nomi_protocol/interfaces/IParaSwapAugustus.sol';
import {ReentrancyGuard} from '../dependencies/openzeppelin/utils/ReentrancyGuard.sol';
import {IERC20Detailed} from '../dependencies/openzeppelin/interface/IERC20Detailed.sol';
...
contract ParaSwapLiquiditySwapAdapter is BaseParaSwapSellAdapter, ReentrancyGuard {
  ...
  ) BaseParaSwapSellAdapter(initialOwner, addressesProvider, augustusRegistry) {
