...
import {PercentageMath} from '../nomi_protocol/libraries/math/PercentageMath.sol';
...
import {IUniswapV2Router02} from '../nomi_protocol/interfaces/IUniswapV2Router02.sol';
import {IPriceOracleGetter} from '../nomi_protocol/interfaces/IPriceOracleGetter.sol';
import {IERC20WithPermit} from '../nomi_protocol/interfaces/IERC20WithPermit.sol';
import {FlashLoanReceiverBase} from '../nomi_protocol/flashloan/FlashLoanReceiverBase.sol';
...
abstract contract BaseUniswapAdapter is FlashLoanReceiverBase, IBaseUniswapAdapter, Ownable {
  ...
  constructor(
    ...
    address wethAddress
  ) FlashLoanReceiverBase(addressesProvider) Ownable(initialOwner) {
