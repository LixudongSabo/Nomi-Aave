...
contract DefaultReserveInterestRateStrategy is IReserveInterestRateStrategy {
  ...
  constructor(
    ...
    uint256 IbaseVariableBorrowRate,
    uint256 IvariableRateSlope1,
    uint256 IvariableRateSlope2,
    uint256 IstableRateSlope1,
    uint256 IstableRateSlope2
  ) {
    OPTIMAL_UTILIZATION_RATE = optimalUtilizationRate;
    EXCESS_UTILIZATION_RATE = WadRayMath.ray().sub(optimalUtilizationRate);
    addressesProvider = provider;
    _baseVariableBorrowRate = IbaseVariableBorrowRate;
    _variableRateSlope1 = IvariableRateSlope1;
    _variableRateSlope2 = IvariableRateSlope2;
    _stableRateSlope1 = IstableRateSlope1;
    _stableRateSlope2 = IstableRateSlope2;
  }
